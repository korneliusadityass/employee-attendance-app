...
class DashboardSaya extends GetView<DashboardSayaController> {
  DashboardSaya({super.key});
      ...
      body: SafeArea(
        child: FutureBuilder<UserMeModel?>(
          ...
          builder:
            ...
            debugPrint('ini nama karyawan $namaKaryawan');
            return ListView(
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<int?>(
                              future: controller.getSisaCutiTahunan(
                    ...
                    rows: <DataRow>[
                      DataRow(
                        cells: <DataCell>[
                          ...
                          DataCell(
                            FutureBuilder<int?>(
                              future: controller.getCutiTahunan(
                      ...
                      DataRow(
                        cells: <DataCell>[
                          ...
                          DataCell(
                            FutureBuilder<int?>(
                              future: controller.getCutiKhusus(
                                  duration: KaryawanDuration.yearly),
                              builder: (context, snapshot) {
                                if (snapshot.hasData) {
                                  return Text(
                      ...
                      DataRow(
                        cells: <DataCell>[
                          ...
                          DataCell(
                            FutureBuilder<int?>(
                              future: controller.getIzinSakit(
                                  duration: KaryawanDuration.yearly),
                              builder: (context, snapshot) {
                                if (snapshot.hasData) {
                                  return Text(
                      ...
                      DataRow(
                        cells: <DataCell>[
                          ...
                          DataCell(
                            FutureBuilder<int?>(
                              future: controller.getPerjalananDinas(
                                  duration: KaryawanDuration.yearly),
                              builder: (context, snapshot) {
                                if (snapshot.hasData) {
                                  return Text(
