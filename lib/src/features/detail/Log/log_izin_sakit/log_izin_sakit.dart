...
import '../../need_aprrove/need_confirm_izin_sakit/widgets/need_confirm_izin_sakit_controller.dart';
import 'widgets/log_izin_sakit_controller.dart';

class LogIzinSakit extends GetView<NeedConfirmIzinSakitController> {
  LogIzinSakit({super.key});
              ...
              children: [
                Expanded(
                  child: SizedBox(
                    width: 149,
                    // height: 55,
                    child: GetBuilder<ListLogIzinSakitController>(builder: (controller) {
