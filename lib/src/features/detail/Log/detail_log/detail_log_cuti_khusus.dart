...
import '../../need_aprrove/detail_need_approve/detail_need_confirm_cuti_khusus/widgets/detail_need_confirm_cuti_khusus_controller.dart';

class CutiKhususDetailLog extends StatefulWidget {
  const CutiKhususDetailLog({super.key});

  @override
  State<CutiKhususDetailLog> createState() => _CutiKhususDetailLogState();
}

class _CutiKhususDetailLogState extends State<CutiKhususDetailLog> {
  ...
  final detailLogCutiKhususController = Get.find<DetailNeedConfirmCutiKhususController>();
  ...
  void initState() {
    super.initState();
    _fetchDataCutiKhusus = detailLogCutiKhususController.execute(args);
    getAttachment(args);
  }
