...
import '../../need_aprrove/need_confirm_perjalanan_dinas/widgets/need_confirm_perjalanan_dinas_controller.dart';
import 'widgets/log_perjalanan_dinas_controller.dart';

class LogPerjalananDinas extends GetView<NeedConfirmPerjalananDinasController> {
  LogPerjalananDinas({super.key});
  ...
  List<dynamic> dataLogPerjalananDinas = [];
  ...
  Future fetchData() async {
    return controller.dataPerjalananDinas.value = await controller.execute(
      page: page,
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: SizedBox(
                          width: 149,
                          child: GetBuilder<ListLogPerjalananDinasController>(builder: (controller) {
                              ...
                              : List<DataRow>.generate(
                                  ...
                                  (int index) {
                                    ...
                                    return DataRow(
                                      onLongPress: () {
                                        Get.toNamed(
                                          Routes.detailLogPerjalananDinas,
                                          arguments: data.id,
                                        );
                                      },
                                      cells: <DataCell>[
                    ...
                    () => Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed:
                              controller.dataPerjalananDinas.length >= pageSize ? () => onPageChange(page + 1) : null,
                        ),
                      ],
                    ),
                  ),
