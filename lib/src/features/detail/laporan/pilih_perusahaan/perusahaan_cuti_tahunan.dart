...
class PerusahaanCutiTahunan extends StatefulWidget {
  const PerusahaanCutiTahunan({super.key});

  @override
  State<PerusahaanCutiTahunan> createState() => _PerusahaanCutiTahunanState();
}

class _PerusahaanCutiTahunanState extends State<PerusahaanCutiTahunan> {
  final controller = Get.find<PerusahaanController>();
  final TextEditingController searchKaryawanController =
      TextEditingController();
  final laporanCutiTahunanController = Get.find<LaporanCutiTahunanController>();
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return GestureDetector(
                          onTap: () async {
                            await laporanCutiTahunanController
                                .execute(hasil.id);
                            Get.toNamed(
                              Routes.pageLaporanCutiTahunan,
                              arguments: hasil.id,
                            );
                          },
                          child: Container(
