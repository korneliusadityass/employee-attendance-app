...
class _PerusahaanPerjalananDinasState extends State<PerusahaanPerjalananDinas> {
  ...
  final laporanPerjalananDinasController =
      Get.find<LaporanPerjalananDinasController>();
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return GestureDetector(
                          onTap: () async {
                            await laporanPerjalananDinasController
                                .execute(hasil.id);
                            Get.toNamed(
                              Routes.pageLaporanPerjalananDinas,
                              arguments: hasil.id,
                            );
                          },
                          child: Container(
