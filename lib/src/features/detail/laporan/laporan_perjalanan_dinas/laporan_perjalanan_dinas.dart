...
class LaporanPerjalananDinas extends GetView<LaporanPerjalananDinasController> {
  LaporanPerjalananDinas({super.key});
  ...
  final exportLaporanPerjalananDinasController =
      Get.find<ExportLaporanPerjalananDinasController>();
  DateTime? endDate;
  DateTime? startDate;
  ...
  Future<void> fetchData() async {
    controller.dataLaporanPerjalananDinas.value = await controller.execute(
      args,
      page: page,
  ...
  Widget build(BuildContext context) {
    void downloadExcel() async {
      ...
      final hasil = await exportLaporanPerjalananDinasController.exportLaporan(
        args,
      ...
      List<ListLaporanPerjalananDinasModel> data = hasil;
      ...
      final file =
          File('${downloadDirectory.path}/LaporanPerjalananDinas.xlsx');
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Flexible(
                        child: SizedBox(
                          height: 50,
                          child: GetBuilder<LaporanPerjalananDinasController>(
                      ...
                      Flexible(
                        child: Column(
                          ...
                          children: [
                            SizedBox(
                              child:
                                  GetBuilder<LaporanPerjalananDinasController>(
                                builder: (controller) =>
                      ...
                      child: DataTable(
                        ...
                        rows: controller.isFetchData.value
                            ...
                            : List<DataRow>.generate(
                                controller.dataLaporanPerjalananDinas.length,
                                (int index) {
                                  // print('TIPE: ${dataIzin3Jam[index]['waktu_awal'].runtimeType}');
                                  int rowIndex =
                                      (page - 1) * pageSize + index + 1;
                                  ListLaporanPerjalananDinasModel data =
                                      controller
                                          .dataLaporanPerjalananDinas[index];
                                  return DataRow(
                                    cells: [
