...
class LaporanCutiKhusus extends GetView<LaporanCutiKhususController> {
  LaporanCutiKhusus({super.key});
  ...
  final exportLaporanCutiKhususController =
      Get.find<ExportLaporanCutiKhususController>();
  DateTime? endDate;
  DateTime? startDate;
  ...
  Future fetchData() async {
    return controller.dataLaporanCutiKhusus.value = await controller.execute(
      args,
      page: page,
  ...
  Widget build(BuildContext context) {
    void downloadExcel() async {
      ...
      final hasil = await exportLaporanCutiKhususController.exportLaporan(
        args,
      ...
      List<ListLaporanCutiKhususModel> data = hasil;
      ...
      final file = File('${downloadDirectory.path}/LaporanCutiKhusus.xlsx');
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Flexible(
                      child: SizedBox(
                        height: 50,
                        child: GetBuilder<LaporanCutiKhususController>(
                          builder: (controller) {
                    ...
                    child: DataTable(
                      ...
                      rows: controller.isFetchData.value
                          ...
                          : List<DataRow>.generate(
                              controller.dataLaporanCutiKhusus.length,
                              (int index) {
                                // print('TIPE: ${dataIzin3Jam[index]['waktu_awal'].runtimeType}');
                                int rowIndex =
                                    (page - 1) * pageSize + index + 1;
                                ListLaporanCutiKhususModel data =
                                    controller.dataLaporanCutiKhusus[index];
                                return DataRow(
                                  cells: [
                  ...
                  () => Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: controller.dataLaporanCutiKhusus.length >=
