...
import 'widgets/need_confirm_perjalanan_dinas_controller.dart';

class NeedConfirmPerjalananDinas extends GetView<NeedConfirmPerjalananDinasController> {
  NeedConfirmPerjalananDinas({super.key});
  ...
  final approvedRefusePerjalananDinasController = Get.find<NeedConfirmPerjalananDinasController>();
                      ...
                      : List<DataRow>.generate(
                          ...
                          (int index) {
                            ...
                            return DataRow(
                              onLongPress: () {
                                Get.toNamed(
                                  Routes.detailNeedConfirmPerjalananDinas,
                                  arguments: data.id,
                                );
                              },
                              cells: <DataCell>[
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          ElevatedButton(
                                                            ...
                                                            onPressed: () async {
                                                              Navigator.pop(context);
                                                              await approvedRefusePerjalananDinasController
                                                                  .perjalananDinasRefuse(data.id);
                                                            },
                                                            child: const Text(
                                                              'Ya',
                                                              style: TextStyle(
                                                        ...
                                                        children: [
                                                          ...
                                                          ElevatedButton(
                                                            ...
                                                            onPressed: () async {
                                                              Navigator.pop(context);
                                                              await approvedRefusePerjalananDinasController
                                                                  .perjalananDinasApproved(data.id);
                                                            },
                                                            child: const Text(
                                                              'Ya',
                                                              style: TextStyle(
