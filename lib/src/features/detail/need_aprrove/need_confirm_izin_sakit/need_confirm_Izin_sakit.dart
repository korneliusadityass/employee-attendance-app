...
import 'widgets/need_confirm_izin_sakit_controller.dart';

class NeedConfirmIzinSakit extends GetView<NeedConfirmIzinSakitController> {
  NeedConfirmIzinSakit({super.key});
  ...
  final approvedRefuseIzinSakitController = Get.find<NeedConfirmIzinSakitController>();
                      ...
                      : List<DataRow>.generate(
                          ...
                          (int index) {
                            ...
                            return DataRow(
                              onLongPress: () {
                                Get.toNamed(
                                  Routes.detailNeedConfirmIzinSakit,
                                  arguments: data.id,
                                );
                              },
                              cells: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          ElevatedButton(
                                                            ...
                                                            onPressed: () async {
                                                              Navigator.pop(context);
                                                              await approvedRefuseIzinSakitController.IzinSakitRefuse(
                                                                  data.id);
                                                            },
                                                            child: const Text(
                                                              'Ya',
