...
class DetailNeedConfirm3Jam extends StatefulWidget {
  const DetailNeedConfirm3Jam({super.key});

  @override
  State<DetailNeedConfirm3Jam> createState() => _DetailNeedConfirm3JamState();
}

class _DetailNeedConfirm3JamState extends State<DetailNeedConfirm3Jam> {
  ...
  final refusedIzin3JamController = Get.find<RefusedIzin3JamController>();
  final approvedIzin3JamController = Get.find<ApprovedIzin3JamController>();
  ...
  //   final result = await HrDetailIzin3JamService().hrDetailIzin3Jam(widget.id);
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                Navigator.pop(context);
                                                await refusedIzin3JamController
                                                    .refusedIzin3Jam(data.id);
                                              },
                                              child: const Text(
                                                'Ya',
                                                style: TextStyle(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                Navigator.pop(context);
                                                await approvedIzin3JamController
                                                    .approveIzin3Jam(data.id);
                                              },
                                              child: const Text(
                                                'Ya',
                                                style: TextStyle(
