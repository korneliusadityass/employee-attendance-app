...
import 'package:project/src/features/detail/need_aprrove/detail_need_approve/detail_need_confirm_perjalanan_dinas/widgets/detail_need_perjalanan_dinas_controller.dart';
...
import '../../need_confirm_perjalanan_dinas/widgets/need_confirm_perjalanan_dinas_controller.dart';

class DetailNeedConfirmPerjalananDinas extends StatefulWidget {
  const DetailNeedConfirmPerjalananDinas({super.key});

  @override
  State<DetailNeedConfirmPerjalananDinas> createState() => _DetailNeedConfirmPerjalananDinasState();
}

class _DetailNeedConfirmPerjalananDinasState extends State<DetailNeedConfirmPerjalananDinas> {
  ...
  final detailNeedConfirmPerjalananDinascontroller = Get.find<DetailNeedConfirmPerjalananDinasController>();
  final getAttachmentEditPerjalananDinasController = Get.find<GetattachmentApprovalPerjalananDinasController>();
  final approveRefusePerjalananDinasController = Get.find<NeedConfirmPerjalananDinasController>();
  ...
  Future downAttach(int idFile, String fileName, BuildContext context) async {
    await hrDownloadAttachmentPerjalananDinasController.downloadAttachment(idFile, fileName, context);
  }

  @override
  void initState() {
    super.initState();
    _fetchDataPerjalananDinas = detailNeedConfirmPerjalananDinascontroller.execute(args);
    getAttachment(args);
  }
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Form(
                ...
                child: ListView(
                  ...
                  children: [
                    const Text(
                      'Detail Need Confirm Perjalanan Dinas',
                      style: TextStyle(
                        fontSize: 26,
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            await approveRefusePerjalananDinasController.perjalananDinasRefuse(data.id);
                          },
                          child: const Text(
                            'Refuse',
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            Navigator.pop(context);
                            await approveRefusePerjalananDinasController.perjalananDinasApproved(data.id);
                          },
                          child: const Text(
                            'Approve',
                            style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: kBlackColor),
