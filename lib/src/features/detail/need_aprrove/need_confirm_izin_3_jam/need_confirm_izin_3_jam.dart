...
class NeedConfirmIzin3Jam extends GetView<NeedConfirmIzin3JamController> {
  NeedConfirmIzin3Jam({super.key});
  ...
  Future<void> fetchData() async {
    controller.dataIzin3Jam.value = await controller.execute(
      page: page,
