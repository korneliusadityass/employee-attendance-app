...
class DetailCutiTahunan extends StatefulWidget {
  const DetailCutiTahunan({super.key});
...
class _DetailCutiTahunanState extends State<DetailCutiTahunan> {
  ...
  final deleteCutiTahunanController = Get.find<DeleteCutiTahunanController>();
  final controller = Get.find<DetailCutiTahunanDataController>();
      ...
      body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting ||
              ...
              print('berhasil');
              DetailPengajuanCutiTahunanModel? data = snapshot.data;
