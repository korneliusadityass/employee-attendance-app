...
import 'package:project/src/features/pengajuan_hr/izin_sakit/pengajuan_izin_sakit_hr.dart';

import '../../../../../util/navhr.dart';
import '../../../../core/colors/color.dart';
import '../../../../core/services/pengajuan_hr_services/izin_sakit_services/confirm_izin_sakit_hr_services.dart';
import '../../../../core/services/pengajuan_hr_services/izin_sakit_services/input_izin_sakit_hr_services.dart';
import '../../../appbar/custom_appbar_widget.dart';

class DetailIzinSakitHR extends StatefulWidget {
  const DetailIzinSakitHR({super.key});
  @override
  State<DetailIzinSakitHR> createState() => _DetailIzinSakitHRState();
}

class _DetailIzinSakitHRState extends State<DetailIzinSakitHR> {
  final TextEditingController tglAwalformController =
      TextEditingController(text: tanggalAwalizinHR);

  final TextEditingController tglAkhirformController =
      TextEditingController(text: tanggalAkhirizinHR);

  final TextEditingController hariController =
      TextEditingController(text: jumlahhariizinHR);
  final TextEditingController judulSakit =
      TextEditingController(text: judulIzinSakitHR);
  final TextEditingController namKaryawanController =
      TextEditingController(text: namaKaryawanHR);
