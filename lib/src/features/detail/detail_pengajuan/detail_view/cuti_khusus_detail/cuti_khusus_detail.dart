...
import 'widget/cuti_khusus_detail_controller.dart';

class CutiKhususDetail extends StatefulWidget {
  const CutiKhususDetail({super.key});

  @override
  State<CutiKhususDetail> createState() => _CutiKhususDetailState();
}

class _CutiKhususDetailState extends State<CutiKhususDetail> {
  ...
  void initState() {
    super.initState();
    _fetchDataCutiKhusus = cutiKhususDetailDatacontroller.execute(args);
    getAttachment(args);
  }
