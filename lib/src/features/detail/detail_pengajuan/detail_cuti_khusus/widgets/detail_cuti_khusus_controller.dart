...
import '../../../../pengajuan/cuti_khusus/widgets/cuti_khusus_controller.dart';

class DetailCutiKhususController extends GetxController {
  PengajuanCutiKhususService service;
  DetailCutiKhususController(this.service);
  ...
  //input attachment
  Future cutiKhususInputAttachment(
    int id,
    List<File> files,
  ) async {
    await service.cutiKhususInputAttachment(id, files);
  }
  ...
  Future cutiKhususConfirm(
    ...
    try {
      ...
      result.fold((failure) {
        ...
        Get.offNamed(Routes.pageCutiKhusus);
        Get.find<CutiKhususController>().execute();
        Get.dialog(Dialog(
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(8),
          ),
