...
class CancelIzinSakitController extends GetxController {
  CancelledIzinSakitServices service;
  CancelIzinSakitController(this.service);

  Future cancelledIzinSakit(int id) async {
    try {
      final result = await service.cancelIzinSakit(id);
      result.fold((failure) {
        Get.dialog(Dialog(
