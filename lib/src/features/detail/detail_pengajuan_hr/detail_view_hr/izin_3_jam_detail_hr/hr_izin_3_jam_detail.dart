...
class HRIzin3JamDetail extends StatefulWidget {
  const HRIzin3JamDetail({super.key});

  @override
  State<HRIzin3JamDetail> createState() => _HRIzin3JamDetailState();
}

class _HRIzin3JamDetailState extends State<HRIzin3JamDetail> {
  ...
  final controller = Get.find<HrDataDetailIzin3JamController>();
              ...
              return Form(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Obx(
                      () => hrDownloadAttachmentIzin3JamController
                              .downloading.value
                          ? LinearProgressIndicator(
                              value: hrDownloadAttachmentIzin3JamController
                                      .progress.value /
                                  100)
                          : const SizedBox(
                              height: 10,
