...
import '../../../detail_pengajuan/detail_view/perjalanan_dinas_detail/widget/perjalanan_dinas_detail_controller.dart';
import 'widgets/perjalanan_dinas_detail_hr_controller.dart';

class HRPerjalananDinasDetail extends StatefulWidget {
  const HRPerjalananDinasDetail({super.key});

  @override
  State<HRPerjalananDinasDetail> createState() => _HRPerjalananDinasDetailState();
}
...
class _HRPerjalananDinasDetailState extends State<HRPerjalananDinasDetail> {
  ...
  final perjalananDinasHrDetailDatacontroller = Get.find<DetailDataHrPerjalananDinasController>();
  ...
  void initState() {
    super.initState();
    _fetchDataPerjalananDinas = perjalananDinasHrDetailDatacontroller.execute(args);
    getAttachment(args);
  }
