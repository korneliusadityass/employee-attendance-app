...
import '../../../detail_pengajuan/detail_view/cuti_tahunan_detail/widget/cuti_tahunan_download_attachment_controller.dart';
import 'widgets/cuti_tahunan_detail_hr_controller.dart';

class CutiTahunanDetailHR extends StatefulWidget {
  const CutiTahunanDetailHR({super.key});

  @override
  State<CutiTahunanDetailHR> createState() => _CutiTahunanDetailHRState();
}

class _CutiTahunanDetailHRState extends State<CutiTahunanDetailHR> {
