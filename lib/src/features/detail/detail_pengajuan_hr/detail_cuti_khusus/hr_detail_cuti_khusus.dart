...
import 'package:project/src/features/detail/detail_pengajuan_hr/detail_cuti_khusus/widget/detail_hr_cuti_khusus_controller.dart';

import '../../../../../util/navhr.dart';
import '../../../../core/colors/color.dart';
import '../../../../core/model/hr_pengajuan_pembatalan/cuti_khusus/hr_cuti_khusus_detail_model.dart';
import '../../../appbar/custom_appbar_widget.dart';
import '../../detail_pengajuan/detail_cuti_khusus/widgets/detail_cuti_khusus_controller.dart';

class HRDetailCutiKhusus extends StatefulWidget {
  const HRDetailCutiKhusus({super.key,});
...
class _HRDetailCutiKhususState extends State<HRDetailCutiKhusus> {
  ...
  final cutiKhususHrDetailController = Get.find<DetailHrCutiKhususController>();
  final cutiKhususInputAttachmentController = Get.find<DetailCutiKhususController>();
  ...
  late Future<HrDetailCutiKhususModel> _fetchDetailCutiKhusus;

  @override
  void initState() {
    super.initState();
    _fetchDetailCutiKhusus = cutiKhususHrDetailController.execute(args);
  }
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting || snapshot.data == null) {
            ...
            HrDetailCutiKhususModel? data = snapshot.data;
                    ...
                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            onPressed: () async {
                                              // HRCutiKhususDeleteService().hrcutiKhususDelete(
                                              //   idCutiKhusus,
                                              //   context,
                                              // );
                                              await cutiKhususHrDetailController.cutiKhususdelete(args);
                                            },
                                            child: const Text(
                                              'Ya',
                                              style: TextStyle(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (files?.isEmpty ?? true) {
                            print('kosongan bang');
                            await cutiKhususHrDetailController.cutiKhususConfirm(args);
                          } else {
                            print('ada isinya bang');
                            await cutiKhususInputAttachmentController.cutiKhususInputAttachment(args, files!);
                            await cutiKhususHrDetailController.cutiKhususConfirm(args);
                          }
                        },
