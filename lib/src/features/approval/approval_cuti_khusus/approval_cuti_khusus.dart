...
import 'widgets/cuti_khusus_approval_controller.dart';

class ApprovalCutiKhusus extends GetView<CutiKhususApprovalController> {
  ApprovalCutiKhusus({super.key});
  ...
  List<dynamic> dataApprovalCutiKhusus = [];
                ...
                Row(
                  children: [
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Get.toNamed(Routes.needConfirmCutiKhusus);
                      },
                      child: const Text(
                        'Need Confirm',
                        style: TextStyle(
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Get.toNamed(Routes.pageLogCutiKhusus);
                      },
                      child: const Text(
                        'Log',
                        style: TextStyle(
                ...
                Row(
                  children: [
                    Expanded(
                      child: SizedBox(
                        width: 149,
                        child: GetBuilder<CutiKhususApprovalController>(builder: (controller) {
