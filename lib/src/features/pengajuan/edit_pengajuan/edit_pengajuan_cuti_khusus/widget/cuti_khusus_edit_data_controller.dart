...
import '../../../cuti_khusus/widgets/cuti_khusus_controller.dart';

class DetailEditCutiKhususController extends GetxController {
  PengajuanCutiKhususService service;
  DetailEditCutiKhususController(this.service);
  ...
  Future cutiKhususDeleteAttachment(int idIjin, int idAttachment) async {
    try {
      final result =
          await service.cutiKhususDeleteAttachment(idIjin, idAttachment);
      result.fold((failure) {
        Get.dialog(Dialog(
