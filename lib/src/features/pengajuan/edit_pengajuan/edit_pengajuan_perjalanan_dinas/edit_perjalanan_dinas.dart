...
import 'package:project/src/features/pengajuan/edit_pengajuan/edit_pengajuan_perjalanan_dinas/widget/perjalanan_dinas_edit_data_controller.dart';
import 'package:project/src/features/pengajuan/perjalanan_dinas/pengajuan_perjalanan_dinas.dart';
...
import '../../../detail/detail_pengajuan/detail_view/perjalanan_dinas_detail/widget/perjalanan_dinas_detail_controller.dart';

class EditPerjalananDinas extends StatefulWidget {
  const EditPerjalananDinas({super.key});
...
class _EditPerjalananDinasState extends State<EditPerjalananDinas> {
  ...
  final perjalananDinasDownloadAttachmentController = Get.find<DetailDataPerjalananDinasController>();
  ...
  Future getAttachment(int id) async {
    resultAttachment = (await perjalananDinasEditcontroller.attach(args)).cast<PerjalananDinasAttachmentModel>();

    return resultAttachment;
  }

  Future downAttach(int idFile, String fileName, context) async {
    await perjalananDinasDownloadAttachmentController.perjalananDinasDownload(idFile, fileName, context);
  }
  ...
  void initState() {
    super.initState();
    _fetchDataPerjalananDinas = perjalananDinasEditcontroller.execute(args);
    getAttachment(args);
  }
              ...
              builder: (context, setState) => Form(
                ...
                child: ListView(
                  ...
                  children: [
                                                            ...
                                                            ElevatedButton(
                                                              ...
                                                              onPressed: () async {
                                                                if (file.id == null) {
                                                                  ...
                                                                  await perjalananDinasEditcontroller
                            ...
                            if (formKey.currentState!.validate()) {
                              if (files?.isEmpty ?? true) {
                                if (data.status == 'Draft') {
                                  await perjalananDinasEditcontroller.perjalananDinasEdit(
                                    args,
                                  ...
                                  await perjalananDinasEditcontroller.perjalananDinasConfirm(args);
                                }
                                ...
                                if (data.status == 'Approved' || data.status == 'Confirmed') {
                                  await perjalananDinasEditcontroller.perjalananDinasInputConfirmedApprovedAttachment(
                                      args, files!);
                                }
                              }
                            }
                    ...
                    Obx(
                      () => perjalananDinasDownloadAttachmentController.downloading.value
                          ? LinearProgressIndicator(
                              value: perjalananDinasDownloadAttachmentController.progress.value / 100)
                          : const SizedBox(
                              height: 10,
                            ),
                    ),
