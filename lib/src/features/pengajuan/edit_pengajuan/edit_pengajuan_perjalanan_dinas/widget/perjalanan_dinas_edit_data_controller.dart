...
import '../../../perjalanan_dinas/widgets/perjalanan_dinas_controller.dart';

class DetailEditPerjalananDinasController extends GetxController {
  PengajuanPerjalananDinasService service;
  DetailEditPerjalananDinasController(this.service);
  ...
  Future perjalananDinasDownload(int idFile, String fileName, BuildContext context) async {
    try {
      ...
      final result =
          await service.perjalananDinasDownload(idFile, fileName, context);
