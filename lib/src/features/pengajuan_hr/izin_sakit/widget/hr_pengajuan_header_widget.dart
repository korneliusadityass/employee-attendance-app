...
class PengajuanHeaderWidgetHR extends StatefulWidget {
  const PengajuanHeaderWidgetHR({super.key});

  @override
  State<PengajuanHeaderWidgetHR> createState() =>
      _PengajuanHeaderWidgetHRState();
}

class _PengajuanHeaderWidgetHRState extends State<PengajuanHeaderWidgetHR> {
  final controller = Get.find<HrInputIzinSakitController>();
  ...
  final pengajuanInputController = Get.find<HrInputIzinSakitController>();
                                ...
                                SizedBox(
                                  ...
                                  child: TypeAheadFormField<dynamic>(
                                    ...
                                    suggestionsCallback: (pattern) async {
                                      List<HrListKaryawanModel> suggestion =
                                          hrListKaryawanController.dataKaryawan
                                              .where((suggestion) {
