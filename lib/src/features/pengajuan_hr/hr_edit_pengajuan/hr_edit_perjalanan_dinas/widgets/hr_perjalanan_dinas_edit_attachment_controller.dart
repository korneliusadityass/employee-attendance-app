...
class EditAttachmentPerjalananDinasController {
  PengajuanPerjalananDinasService service;
  EditAttachmentPerjalananDinasController(this.service);
  Future perjalananDinasInputConfirmedApprovedAttachment(
    int id,
    List<File> files,
  ) async {
    try {
      final result = await service.perjalananDinasInputAttachment(id, files);
      result.fold((failure) {
        Get.dialog(Dialog(
