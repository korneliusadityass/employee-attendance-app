...
import '../../../perjalanan_dinas/widget/hr_perjalanan_dinas_list_controller.dart';

class DetailEditHrPerjalananDinasController extends GetxController {
  HRPerjalananDinasService service;
  DetailEditHrPerjalananDinasController(this.service);
  ...
  Future perjalananDinasEdit(
    int id,
    String judul,
    String tanggalAwal,
    String tanggalAkhir,
  ) async {
    await service.perjalananDinasEdit(id, judul, tanggalAwal, tanggalAkhir);
  }
  ...
  Future inputPerjalananDinas(
    ...
    try {
      ...
      result.fold((failure) {
        ...
        await Get.toNamed(Routes.detailCutiKhusus, arguments: success);
      });
    } catch (e) {
  ...
  Future perjalananDinasDeleteAttachment(int idIjin, int idAttachment) async {
    try {
      final result = await service.perjalananDinasDeleteAttachment(idIjin, idAttachment);
      result.fold((failure) {
        Get.dialog(Dialog(
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(10),
  ...
  Future perjalananDinasConfirm(
    ...
    try {
      ...
      result.fold((failure) {
        ...
        Get.offNamed(Routes.pageHrPerjalananDinas);
        Get.find<HrPerjalananDinasController>().execute();
        Get.dialog(Dialog(
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(8),
          ),
