...
class HREditPengajuanIzin3Jam extends StatefulWidget {
  const HREditPengajuanIzin3Jam({super.key});

  @override
  State<HREditPengajuanIzin3Jam> createState() =>
      _HREditPengajuanIzin3JamState();
}

class _HREditPengajuanIzin3JamState extends State<HREditPengajuanIzin3Jam> {
  ...
  final hrGetAttachmentIzin3JamDetailController =
      Get.find<HrGetAttachmentIzin3JamDetailController>();
  final hrInputAttachmentConfirmedApprovedEditIzin3JamController =
      Get.find<HrInputAttachmentConfirmedApprovedEditIzin3JamController>();
  final hrEditIzin3JamController = Get.find<HrEditIzin3JamController>();
  final hrDeleteAttachmentEditIzin3JamController =
      Get.find<HrDeleteAttachmentEditIzin3JamController>();
  ...
  late Future<HrDataDetailIzin3JamModel> _fetchDataIzin3Jam;
  List<AttachmentIzin3JamModel> resultAttachment = [];

  Future getAttachment(int id) async {
    resultAttachment =
        await hrGetAttachmentIzin3JamDetailController.attach(args);
        ...
        body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting ||
              ...
              HrDataDetailIzin3JamModel? data = hasil['value1'];
              ...
              TimeOfDay formatDurasiAkhir =
                  TimeOfDay.fromDateTime(dateTimeAkhir);
              ...
              combinedList = [
                ...data2,
                ...?files?.map((file) => AttachmentIzin3JamModel(
                                                              ...
                                                              ElevatedButton(
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  if (file.id ==
                                                                    ...
                                                                    await hrDeleteAttachmentEditIzin3JamController
                                                                        .deleteAttachmentEdit3Jam(
                                                                            args,
                                                                            file.id!);
                                                                    combinedList.removeWhere((element) =>
                                                                        element
                                                                            .id ==
                                                                        file.id);
                                                                  }
                              ...
                              if (formkey.currentState!.validate()) {
                                if (files?.isEmpty ?? true) {
                                  if (data.status == 'Draft') {
                                    await hrEditIzin3JamController.editIzin3Jam(
                                      args,
                                  ...
                                  if (data.status == 'Approved' ||
                                      data.status == 'Confirmed') {
                                    await hrInputAttachmentConfirmedApprovedEditIzin3JamController
