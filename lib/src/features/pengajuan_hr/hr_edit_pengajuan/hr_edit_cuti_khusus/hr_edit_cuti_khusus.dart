...
import '../../cuti_khusus/hr_pengajuan_cuti_khusus.dart';
import '../../cuti_khusus/widget/hr_cuti_khusus_controller.dart';
import 'widgets/hr_cuti_khusus_edit_data_controller.dart';
import 'widgets/hr_cuti_khusus_update_attachment_controller.dart';

class HREditCutiKhusus extends StatefulWidget {
  const HREditCutiKhusus({super.key});

  @override
  State<HREditCutiKhusus> createState() => _HREditCutiKhususState();
}

class _HREditCutiKhususState extends State<HREditCutiKhusus> {
  ...
  final hrCutiKhususEditcontroller =
      Get.find<DetailEditHrCutiKhususController>();
  final hrCutiKhususcontroller = Get.find<HrCutiKhususController>();
  final cutiKhususEditcontroller = Get.find<DetailEditCutiKhususController>();
  final cutiKhususEditAttachmentcontroller =
      Get.find<EditAttachmentCutiKhususController>();
  ...
  void initState() {
    super.initState();
    _fetchDataCutiKhusus = hrCutiKhususEditcontroller.execute(args);
    getAttachment(args);
  }
                                                            ...
                                                            ElevatedButton(
                                                              ...
                                                              onPressed:
                                                                ...
                                                                if (file.id ==
                                                                  ...
                                                                  await hrCutiKhususEditcontroller
                            ...
                            if (formKey.currentState!.validate()) {
                              if (files?.isEmpty ?? true) {
                                ...
                                if (data.status == 'Approved' ||
                                  ...
                                  await hrCutiKhususcontroller.execute();
                                  Get.offNamed(Routes.pageHrCutiKhusus);
                                }
                              } else {
                                if (data.status == 'Draft') {
                                  await hrCutiKhususEditcontroller
                                ...
                                if (data.status == 'Approved' ||
                                    data.status == 'Confirmed') {
                                  await cutiKhususEditAttachmentcontroller
