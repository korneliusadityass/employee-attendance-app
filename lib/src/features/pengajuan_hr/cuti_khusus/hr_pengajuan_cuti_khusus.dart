...
import 'widget/hr_cuti_khusus_controller.dart';
...
class _HRPengajuanCutiKhususState extends State<HRPengajuanCutiKhusus> {
  ...
  final cutiKhususHrController = Get.find<HrCutiKhususController>();
  ...
  Future<void> fetchData() async {
    await cutiKhususHrController.execute(
      page: page,
  ...
  void onPageChange(int newPage) {
    page = newPage;
    cutiKhususHrController.pageNum.value = newPage;
    fetchData();
  }

  Future hasSeen() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    final result = prefs.getBool('hasSeenTutorial Hr Pengajuan Cuti Khusus') ?? false;
    return result;
  }
  ...
  void _showTutorialCoachmark() {
    ...
    tutorialCoachMark = TutorialCoachMark(
        ...
        onSkip: () async {
          SharedPreferences prefs = await SharedPreferences.getInstance();
          prefs.setBool('hasSeenTutorial Hr Pengajuan Cuti Khusus', true);
        },
        onFinish: () {})
                                        ...
                                        TypeAheadFormField<dynamic>(
                                          ...
                                          suggestionsCallback: (pattern) async {
                                            final List<HrListKaryawanModel> suggestions =
                                                await cutiKhususHrController.executekaryawan(
                                              filterNama: pattern,
                                            );
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                if (formkey.currentState!.validate()) {
                                                  final result = await cutiKhususHrController.inputCutiKhusus(
                                                    selectedId!,
                                                  ...
                                                  print('INI ID : $result');
                                                  await Get.toNamed(Routes.detailHrCutiKhusus, arguments: result);
                                                }
                                              },
                                              child: const Text(
                                                'Save',
                ...
                Obx(
                  () => SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: cutiKhususHrController.isFetchData.value
                          ? [
                              const DataRow(
                                cells: [
                          ...
                          : List<DataRow>.generate(
                              cutiKhususHrController.dataCutiKhusus.length,
                              (int index) {
                                int rowIndex = (page - 1) * pageSize + index + 1;
                                HrCutiKhususListModel data = cutiKhususHrController.dataCutiKhusus[index];
                                return DataRow(
                                  onLongPress: () async {
                                    await Get.toNamed(Routes.cutiKhususHrDetail, arguments: data.id);
                                  },
                                  cells: [
                  ...
                  () => Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: cutiKhususHrController.pageNum.value > 1
                            ? () => onPageChange(cutiKhususHrController.pageNum.value - 1)
                            : null,
                      ),
                      Container(
                        width: 30,
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              '${cutiKhususHrController.pageNum.value}',
                              style: const TextStyle(
                                fontSize: 14,
                                color: kWhiteColor,
                                fontWeight: FontWeight.w600,
                      ...
                      IconButton(
                        ...
                        onPressed: cutiKhususHrController.dataCutiKhusus.length >= cutiKhususHrController.pageSize.value
                            ? () => onPageChange(page + 1)
                            : null,
                      ),
                    ],
