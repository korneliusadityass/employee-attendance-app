...
import '../../pengajuan/cuti_khusus/coachmark.dart';
import 'widget/hr_perjalanan_dinas_list_controller.dart';

class HRPengajuanPerjalananDinas extends StatefulWidget {
  const HRPengajuanPerjalananDinas({super.key});

  @override
  State<HRPengajuanPerjalananDinas> createState() => _HRPengajuanPerjalananDinasState();
}

class _HRPengajuanPerjalananDinasState extends State<HRPengajuanPerjalananDinas> {
  ...
  // final TextEditingController durasiHariController = TextEditingController();
  ...
  final perjalananDinasHrController = Get.find<HrPerjalananDinasController>();
  ...
  List<dynamic> dataPerjalananDinas = [];

  Future<void> fetchData() async {
    perjalananDinasHrController.dataPerjalananDinas.value = await perjalananDinasHrController.execute(
      page: page,
  ...
  void onPageChange(int newPage) {
    page = newPage;
    perjalananDinasHrController.pageNum.value = newPage;
    fetchData();
  }

  Future hasSeen() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    final result = prefs.getBool('hasSeenTutorial Hr Pengajuan Perjalanan Dinas') ?? false;
    return result;
  }
  ...
  void _showTutorialCoachmark() {
    ...
    tutorialCoachMark = TutorialCoachMark(
        ...
        onSkip: () async {
          SharedPreferences prefs = await SharedPreferences.getInstance();
          prefs.setBool('hasSeenTutorial Hr Pengajuan Perjalanan Dinas', true);
        },
        onFinish: () {})
                                      ...
                                      children: [
                                        ...
                                        TypeAheadFormField<dynamic>(
                                          ...
                                          suggestionsCallback: (pattern) async {
                                            final List<HrListKaryawanModel> suggestions =
                                                await perjalananDinasHrController.executekaryawan(
                                              filterNama: pattern,
                                            );
                                            return suggestions.map((karyawan) => karyawan.toJson()).toList();
                                          },
                                          itemBuilder: (context, dynamic suggestion) {
                                            final namaKaryawan = suggestion['nama_karyawan'] as String;
                                            return ListTile(
                                              title: Text(namaKaryawan),
                                            );
                                          },
                                          onSuggestionSelected: (dynamic suggestion) {
                                            selectedId = suggestion['id'] as int;
                                            namaKaryawanController.text = suggestion['nama_karyawan'] as String;
                                            debugPrint('ID Karyawan : $selectedId');
                                          },
                                          validator: (value) {
                                            if (value!.isEmpty) {
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                if (formkey.currentState!.validate()) {
                                                  final result = await perjalananDinasHrController.inputPerjalananDinas(
                                                    selectedId!,
                                                  ...
                                                  print('INI ID : $result');
                                                  await Get.toNamed(Routes.detailHrPerjalananDinas, arguments: result);
                                                }
                                              },
                                              child: const Text(
                                                'Save',
                ...
                Obx(
                  () => SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: perjalananDinasHrController.isFetchData.value
                          ? [
                              const DataRow(
                                cells: [
                          ...
                          : List<DataRow>.generate(
                              perjalananDinasHrController.dataPerjalananDinas.length,
                              (int index) {
                                int rowIndex = (page - 1) * pageSize + index + 1;
                                HrPerjalananDinasListModel data =
                                    perjalananDinasHrController.dataPerjalananDinas[index];
                                return DataRow(
                                  onLongPress: () async {
                                    await Get.toNamed(Routes.perjalananDinasHrDetail, arguments: data.id);
                                  },
                                  cells: [
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    ElevatedButton(
                                                                      ...
                                                                      onPressed: () async {
                                                                        Navigator.pop(context);
                                                                        await perjalananDinasHrController
                  ...
                  () => Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: perjalananDinasHrController.pageNum.value > 1
                            ? () => onPageChange(perjalananDinasHrController.pageNum.value - 1)
                            : null,
                      ),
                      Container(
                        width: 30,
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              '${perjalananDinasHrController.pageNum.value}',
                              style: const TextStyle(
                                fontSize: 14,
                                color: kWhiteColor,
                                fontWeight: FontWeight.w600,
                      ...
                      IconButton(
                        ...
                        onPressed: perjalananDinasHrController.dataPerjalananDinas.length >=
                                perjalananDinasHrController.pageSize.value
                            ? () => onPageChange(page + 1)
                            : null,
                      ),
                    ],
