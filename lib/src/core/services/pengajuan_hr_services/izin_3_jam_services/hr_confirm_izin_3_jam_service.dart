...
class Izin3JamConfirmHRService {
  final url = 'http://192.168.2.155:8000/ijin_3_jam/hr/confirm';
  Dio dio = Dio();
  final pref = Get.find<AuthStorageHelper>();

  Future izin3JamConfirmHR(int id, BuildContext context) async {
    try {
      // final tokenResponse = '';
