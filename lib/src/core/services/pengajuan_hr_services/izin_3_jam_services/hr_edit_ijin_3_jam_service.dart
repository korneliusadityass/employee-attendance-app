...
class EditIzin3JamHRService {
  final url = 'http://192.168.2.155:8000/ijin_3_jam/hr/update';
  Dio dio = Dio();
  final pref = Get.find<AuthStorageHelper>();

  Future editIzin3JamHR(int id, String judul, String tanggal, String waktuAwal,
...
class HrEditIzin3JamService {
  DioClients dio;
  HrEditIzin3JamService(this.dio);
