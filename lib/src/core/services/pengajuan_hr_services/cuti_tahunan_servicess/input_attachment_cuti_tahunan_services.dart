...
class InputAttachmentCutiTahunanHrServices {
  DioClients dio;
  InputAttachmentCutiTahunanHrServices(this.dio);

  Future inputAttachmentCutiTahunantHr(int id, List<File> files) async {
    try {
