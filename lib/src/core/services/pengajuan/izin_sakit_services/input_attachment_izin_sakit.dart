...
class InputAttachmentIzinSakitServicess {
  DioClients dio;
  InputAttachmentIzinSakitServicess(this.dio);

  Future inputAttachmentizinsakitt(int id, List<File> files) async {
    try {
      ...
      return Left(InputAttachmentizinSakitFailure(errorMessage));
    }
  }
}
