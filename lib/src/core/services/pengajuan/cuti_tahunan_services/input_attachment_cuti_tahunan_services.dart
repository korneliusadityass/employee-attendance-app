...
class InputAttachmentCutiTahunanServicess {
  DioClients dio;
  InputAttachmentCutiTahunanServicess(this.dio);

  Future inputAttachmentCutiTahunan(int id, List<File> files) async {
    try {
      ...
      return Left(InputAttachmentCutiTahunanFailure(errorMessage));
    }
  }
}
