...
class ExportLaporanIzinSakitService {
  DioClients dio;
  ExportLaporanIzinSakitService(this.dio);

  Future<Either<Failure, List<ListLaporanIzinSakitModel>>>
      exportLaporanIzinSakit(
    int id, {
    String filterStatus = 'All',
    String? filterNama,
    String? tanggalAwal,
    ...
    try {
      ...
      final response = await dio.dio.get(
        'laporan/ijin_sakit/export',
        queryParameters: queryParameters,
      );
      List result = response.data;

      return right(
        result.map((data) => ListLaporanIzinSakitModel.fromJson(data)).toList(),
      );
    } on DioError catch (e) {
