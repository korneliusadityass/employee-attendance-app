...
class HrDetailCutiKhususModel {
  ...
  factory HrDetailCutiKhususModel.fromRawJson(String str) => HrDetailCutiKhususModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory HrDetailCutiKhususModel.fromJson(Map<String, dynamic> json) => HrDetailCutiKhususModel(
        id: json["id"],
        judul: json["judul"],
