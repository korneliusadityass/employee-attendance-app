...
class HrListKaryawanModel {
  ...
  factory HrListKaryawanModel.fromRawJson(String str) => HrListKaryawanModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory HrListKaryawanModel.fromJson(Map<String, dynamic> json) => HrListKaryawanModel(
        id: json["id"],
