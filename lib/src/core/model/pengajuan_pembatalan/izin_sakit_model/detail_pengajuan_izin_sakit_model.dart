...
class DetailPengajuanIzinSakitModel {
  final int id;
  final String judul;
  ...
  factory DetailPengajuanIzinSakitModel.fromRawJson(String str) => DetailPengajuanIzinSakitModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailPengajuanIzinSakitModel.fromJson(Map<String, dynamic> json) => DetailPengajuanIzinSakitModel(
        id: json["id"],
        judul: json["judul"],
