...
//
//     final cutiKhususListModel = cutiKhususListModelFromJson(jsonString);

import 'dart:convert';

class CutiKhususListModel {
  CutiKhususListModel({
    required this.id,
    required this.judul,
  ...
  factory CutiKhususListModel.fromRawJson(String str) =>
      CutiKhususListModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CutiKhususListModel.fromJson(Map<String, dynamic> json) =>
      CutiKhususListModel(
        id: json["id"],
        judul: json["judul"],
