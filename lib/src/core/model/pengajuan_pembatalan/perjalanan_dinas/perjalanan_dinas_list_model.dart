...
//
//     final perjalananDinasListModel = perjalananDinasListModelFromJson(jsonString);

import 'dart:convert';

class PerjalananDinasListModel {
  PerjalananDinasListModel({
    required this.id,
    required this.judul,
  ...
  factory PerjalananDinasListModel.fromRawJson(String str) =>
      PerjalananDinasListModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PerjalananDinasListModel.fromJson(Map<String, dynamic> json) =>
      PerjalananDinasListModel(
        id: json["id"],
        judul: json["judul"],
