...
class DetailPengajuanCutiTahunanModel {
  final int id;
  ...
  DetailPengajuanCutiTahunanModel({
    required this.id,
  ...
  factory DetailPengajuanCutiTahunanModel.fromRawJson(String str) =>
      DetailPengajuanCutiTahunanModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailPengajuanCutiTahunanModel.fromJson(Map<String, dynamic> json) =>
      DetailPengajuanCutiTahunanModel(
        id: json["id"],
