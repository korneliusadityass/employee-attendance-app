...
//
//     final listLaporanPerjalananDinasModel = listLaporanPerjalananDinasModelFromJson(jsonString);

import 'dart:convert';

class ListLaporanPerjalananDinasModel {
  final int id;
  ...
  ListLaporanPerjalananDinasModel({
    required this.id,
  ...
  factory ListLaporanPerjalananDinasModel.fromRawJson(String str) =>
      ListLaporanPerjalananDinasModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ListLaporanPerjalananDinasModel.fromJson(Map<String, dynamic> json) =>
      ListLaporanPerjalananDinasModel(
        id: json["id"],
