...
class DetailNeedCutiKhususModel {
  final int id;
  final String judul;
  ...
  factory DetailNeedCutiKhususModel.fromRawJson(String str) => DetailNeedCutiKhususModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailNeedCutiKhususModel.fromJson(Map<String, dynamic> json) => DetailNeedCutiKhususModel(
        id: json["id"],
        judul: json["judul"],
