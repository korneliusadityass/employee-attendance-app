...
class ApprovalCutiTahunanListModel {
  ApprovalCutiTahunanListModel({
    required this.id,
    required this.judul,
  ...
  factory ApprovalCutiTahunanListModel.fromRawJson(String str) =>
      ApprovalCutiTahunanListModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ApprovalCutiTahunanListModel.fromJson(Map<String, dynamic> json) =>
      ApprovalCutiTahunanListModel(
        id: json["id"],
        judul: json["judul"],
