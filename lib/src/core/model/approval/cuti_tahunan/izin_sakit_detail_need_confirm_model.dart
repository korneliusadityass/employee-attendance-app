...
class DetailNeedCutiTahunanModel {
  final int id;
  final String judul;
  ...
  factory DetailNeedCutiTahunanModel.fromRawJson(String str) => DetailNeedCutiTahunanModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailNeedCutiTahunanModel.fromJson(Map<String, dynamic> json) => DetailNeedCutiTahunanModel(
        id: json["id"],
        judul: json["judul"],
