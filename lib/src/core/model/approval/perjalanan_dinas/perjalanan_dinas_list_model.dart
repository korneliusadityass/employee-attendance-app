...
class ApprovalPerjalananDinasListModel {
    ApprovalPerjalananDinasListModel({
        required this.id,
        required this.judul,
    ...
    factory ApprovalPerjalananDinasListModel.fromRawJson(String str) => ApprovalPerjalananDinasListModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ApprovalPerjalananDinasListModel.fromJson(Map<String, dynamic> json) => ApprovalPerjalananDinasListModel(
        id: json["id"],
        judul: json["judul"],
