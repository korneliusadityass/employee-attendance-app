...
class DetailNeedPerjalananDinasModel {
  final int id;
  final String judul;
  ...
  DetailNeedPerjalananDinasModel({
    required this.id,
    required this.judul,
  ...
  factory DetailNeedPerjalananDinasModel.fromRawJson(String str) => DetailNeedPerjalananDinasModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailNeedPerjalananDinasModel.fromJson(Map<String, dynamic> json) => DetailNeedPerjalananDinasModel(
        id: json["id"],
        judul: json["judul"],
