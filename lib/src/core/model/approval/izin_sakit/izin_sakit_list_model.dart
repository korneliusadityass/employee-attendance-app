...
class ApprovalIzinSakitListModel {
  ApprovalIzinSakitListModel({
    required this.id,
    required this.judul,
  ...
  factory ApprovalIzinSakitListModel.fromRawJson(String str) =>
      ApprovalIzinSakitListModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ApprovalIzinSakitListModel.fromJson(Map<String, dynamic> json) =>
      ApprovalIzinSakitListModel(
        id: json["id"],
        judul: json["judul"],
