...
class DetailNeedIzinSakitModel {
  final int id;
  final String judul;
  ...
  factory DetailNeedIzinSakitModel.fromRawJson(String str) => DetailNeedIzinSakitModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailNeedIzinSakitModel.fromJson(Map<String, dynamic> json) => DetailNeedIzinSakitModel(
        id: json["id"],
        judul: json["judul"],
